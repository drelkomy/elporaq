<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}" dir="rtl">
        @csrf
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full text-right" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
