...
document.addEventListener('DOMContentLoaded', function() {
  ...
  icons.forEach(icon => {
      icon.addEventListener('click', function() {
          icons.forEach(i => i.classList.remove('selected')); // إزالة التحديد من كل الأيقونات
          this.classList.add('selected'); // إضافة التحديد للأيقونة المختارة
          selectedIconInput.value = this.getAttribute('data-icon'); // تحديث القيمة المخفية بالنموذج
      });
  });
});
